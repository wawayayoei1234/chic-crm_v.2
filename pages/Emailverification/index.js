...
function Index() {
  ...
  return (
      ...
      <Box sx={{background:"linear-gradient(110deg, #84BAA1, #FFFBE2 100%)",height:"100vh",width:'100%'}}>
        <Box p={1} sx={{display:'flex',flexDirection:'column', background: 'white',
        ...
        transform: 'translate(-50%, -50%)'}}> 
          ...
          <Box >
          <OtpInput className='otp-input-container'
            value={otp}
            onChange={setOtp}
            numInputs={6}
            separator={<Box></Box>}
          ...
          width: '300px', height: 'auto',textTransform:'capitalize', fontFamily: 'Avenir' }}>Next</Button>
          <Box>
            <label style={{color:'#7F8391',fontSize: 15, fontFamily: 'Avenir'}}>Didn’t receive code?</label>
